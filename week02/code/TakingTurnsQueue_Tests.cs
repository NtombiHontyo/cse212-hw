...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Removing items from queue at incorrect index. No condition set for when a person has infinite turns therefore it was not enqueueing them correctly.
